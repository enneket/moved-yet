...
# Moved Yet v0.0.2 发布脚本
# 使用方法: ./sh/release-v0.0.2.sh

set -e

echo "🚀 开始发布 Moved Yet v0.0.2..."
...
# 6. 显示包信息
VSIX_FILE="moved-yet-0.0.2.vsix"
if [ -f "$VSIX_FILE" ]; then
...
echo "  4. 创建 Git 标签: git tag v0.0.2 && git push origin v0.0.2"
echo ""
echo "📚 新功能测试："
